            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="row">
                        ...
                        <div class="courses_reg_form_col">
                            ...
                            <div class="courses_reg_tesvan_form">
                                ...
                                <form autocomplete="off">
                                    ...
                                    <div class="form-group courses_reg_custom_form_group">
                                        ...
                                        <input type="text" class="name form-control courses_reg_custom_form_input" id="name"></div>
                                        <div class="form-group courses_reg_custom_form_group">
                                            <label for="surname">Surname</label>
                                            <input
                                                type="text"
                                                class="surname form-control courses_reg_custom_form_input"
                                                id="surname"></div>
                                            <div class="form-group courses_reg_custom_form_group">
                                                <label for="email">Email</label>
                                                <input
                                                    type="email"
                                                    class="form-control email courses_reg_custom_form_input"
                                                    id="email"></div>
                                                <div class="form-group courses_reg_custom_form_group">
                                                    <label for="phone">Phone</label>
                                                    <input type="tel" class="phone form-control courses_reg_custom_form_input" id="phone"></div>
